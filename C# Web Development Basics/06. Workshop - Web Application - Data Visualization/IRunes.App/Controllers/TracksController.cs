...
namespace IRunes.App.Controllers
{
    public class TracksController : BaseController
    {
        ...
        public IHttpResponse Details(IHttpRequest request)
        {
            ...
            trackDetails.Append($@"<h3>Track Name: {track.Name}</h3></ br>");
            trackDetails.Append($@"<h3>Track Price: &#36;{priceWithComma}</h3></ br>");
            trackDetails.Append(@"<hr style=""height: 2px"" class=""bg-success"" />");
            trackDetails.Append($@"<iframe src=""{trackLink}""  width=""640"" height=""360""></iframe>");
